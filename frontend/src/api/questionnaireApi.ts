...
export function getQuestionnaireAnalysis(
  questionnaireId: number,
): Promise<QuestionnaireAnalysis> {
  return apiClient<QuestionnaireAnalysis>({
    url: `/api/v1/questionnaires/${questionnaireId}/analysis`,
    method: "GET",
  });
}

export function getDoctorQuestionnaireAnalysis(
  questionnaireId: number,
): Promise<QuestionnaireAnalysis> {
  return apiClient<QuestionnaireAnalysis>({
    url: `/api/v1/doctors/questionnaires/${questionnaireId}/analysis`,
    method: "GET",
  });
}
