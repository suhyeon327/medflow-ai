...
import { ADMIN_HOSPITALS_PATH, ADMIN_USERS_PATH, DOCTOR_PROFILE_PATH, DOCTOR_SCHEDULES_PATH, HOSPITALS_PATH, LOGIN_PATH, PATIENT_PROFILE_PATH, PATIENT_RESERVATIONS_PATH, WITHDRAW_PATH } from '../routes/routePaths';
