...
public record QuestionnaireCreateRequest(
        ...
        @Size(max = 200, message = "주 증상은 200자 이하여야 합니다.")
        ...
        @Size(max = 10000, message = "증상 상세 설명은 10000자 이하여야 합니다.")
        ...
        @Size(max = 10000, message = "동반 증상은 10000자 이하여야 합니다.")
        String associatedSymptoms,

        @Size(max = 10000, message = "기저질환은 10000자 이하여야 합니다.")
        String medicalHistory,

        @Size(max = 10000, message = "복용 중인 약은 10000자 이하여야 합니다.")
        String medications,

        @Size(max = 10000, message = "알레르기는 10000자 이하여야 합니다.")
        String allergies,

        @Size(max = 10000, message = "추가 전달사항은 10000자 이하여야 합니다.")
