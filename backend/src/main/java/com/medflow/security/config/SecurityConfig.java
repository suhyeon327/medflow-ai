package com.medflow.security.config;

import com.medflow.security.handler.CustomAuthenticationEntryPoint;
import com.medflow.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .addFilterBefore(
                        new JwtAuthenticationFilter(jwtTokenParser, userPrincipalService),
